<template>
  <div>
    <!-- Lesson 8 - using slots and named slots -->
    <div class="text-center p-1 my-8">
      <primary-button>
    ...
    <div class="max-w-xs mx-auto mb-8">
      <media-card>
        ...
        <template slot="heading">
          The Long Road to Mastering the Perfect Cartwheel - Lesson 8
        </template>
        <p>
    ...
    <div class="max-w-xs mx-auto mb-8">
      <media-card>
        <template slot="heading">
          Crossing the Street for Dummies - Lesson 8
        </template>
        <p>
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Officia eos
          accusantium minima architecto natus sequi quisquam incidunt dolorem,
