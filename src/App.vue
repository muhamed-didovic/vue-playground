<template>
  <div>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarColor02">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <router-link class="nav-link" to="/26">26</router-link>
          </li>
          <li class="nav-item">
            <router-link class="nav-link" to="/27">27</router-link>
          </li>
          <li class="nav-item">
            <router-link class="nav-link" to="/28">28</router-link>
          </li>
          <li class="nav-item">
    ...
    <div id="app" class="wrap"><router-view /></div>
  </div>
</template>
...
<style src="./assets/css/bootstrap.css" /> <style src="./assets/css/app.css" />
<style>
/*#app {*/
